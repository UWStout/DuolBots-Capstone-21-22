...
namespace DuolBots
{
    ...
    /// build bot scene.
    /// </summary>
    public class FlipAnimation : ScriptedAnimation
    {
        [SerializeField] [Required] private ChassisMoveSelectOnReadyUp m_readyUpMan = null;
        [SerializeField] [Min(0)] private int m_selectionIndex = 0;
