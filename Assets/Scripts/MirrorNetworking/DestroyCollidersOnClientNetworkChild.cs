...
namespace DuolBots.Mirror
{
    ...
    /// <see cref="NetworkChildIdentity"/>. See also the variant meant to be
    /// attached to a <see cref="NetworkIdentity"/> which is similarly called
    /// <see cref="DestroyCollidersOnClient"/>.
    /// </summary>
    public class DestroyCollidersOnClientNetworkChild : NetworkChildBehaviour
    {
